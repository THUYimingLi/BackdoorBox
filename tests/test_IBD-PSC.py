...
# ========== ResNet-18_CIFAR-10_Attack_IBD-PSC ==========
# ===================== Benign ======================
model_name, dataset_name, attack_name, defense_name = 'ResNet-18', 'CIFAR-10', 'Benign', 'IBD-PSC'
...
defense = core.IBD_PSC(model=benign_model, valset=val_set)
...
target_label = 0
# ===================== BadNets ======================
model_name, dataset_name, attack_name, defense_name = 'ResNet-18', 'CIFAR-10', 'BadNets', 'IBD-PSC'
...
defense = core.IBD_PSC(model=badnet_model, valset=val_set)
