...
|          [FLARE](https://github.com/THUYimingLi/BackdoorBox/blob/main/core/defenses/FLARE.py) | FLARE: Towards Universal Dataset Purification against Backdoor Attacks. [TIFS, 2025](https://arxiv.org/abs/2411.19479). | dataset purification. | 
A universal method demonstrated to be effective against all-to-one, all-to-all, and untargeted backdoor attack types.|
